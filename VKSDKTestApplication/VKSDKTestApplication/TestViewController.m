...
- (void)sharePhoto {
    NSArray *items = @[[UIImage imageNamed:@"example.jpg"], @"Противостояние Запада и России" , [NSURL URLWithString:@"https://www.youtube.com/watch?v=Ke3Pz8FDrLc"]];
    ...
    [activityViewController setValue:@"Перезагрузка" forKey:@"subject"];
